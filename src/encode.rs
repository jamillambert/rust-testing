//! Provides functions to encode strings into various formats.
...
/// ```
pub fn bech32_encode(input: &str) -> String {
...
/// ```
pub fn base58check_encode(input: &str) -> String {
    let mut bytes = vec![0];
...
/// ```
pub fn convert_base58_to_base58check(input: &str) -> String {
